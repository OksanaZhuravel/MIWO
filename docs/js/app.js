    ...
    if (animItems.length) {
        ...
        function animOnScroll(params) {
            for (let index = 0; index < animItems.length; index++) {
                ...
                if (scrollY > animItemOffset - animItemPoint && scrollY < animItemOffset + animItemHeight) animItem.classList.add("_active"); else if (!animItem.classList.contains("_anim-no")) animItem.classList.remove("_active");
            }
            function offset(el) {
